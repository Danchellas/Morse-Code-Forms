...
namespace LibMorseCode
{
    public class MorseCode
    {
        ...
        private const string PATH_RUS = @"E:\Morse-Code-Forms\RussianDictionary.txt"; //Константа, хранящая адрес русского словаря
        private const string PATH_EN = @"E:\Morse-Code-Forms\EnglishDictionary.txt";  //Константа, хранящая адрес английского словаря
